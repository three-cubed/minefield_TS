...
function drawTiles(borderColourToDraw: string = '.*', text: any = null, fontSize: string | number = dimensionsOfSquaresInPixels * 0.2) {
    let currText = text;
...
function drawTile(tile: Tile, text: string, fontSize: any) {
    // The tile itself
...
function findNeighbours(tile: Tile) {
    // DANGER!
