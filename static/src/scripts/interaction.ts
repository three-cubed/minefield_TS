...
function moveTileFocus(tileToFocusOn: Tile) {
    if (
        tileToFocusOn === null
...
function hasValidNeighbour(currentTile: Tile): boolean {
...
function setTileToBeHighlighted(tileToHighlight: Tile): void {
    for (const tile of tiles) {
...
function colourInBorder(tile: Tile, colourToUse = tile.borderColour) {
...
function doIfComplete(currentTile: Tile): void {
